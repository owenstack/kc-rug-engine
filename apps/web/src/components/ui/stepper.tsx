	...
	const registerTrigger = React.useCallback(
		(node: HTMLButtonElement | null) => {
			setTriggerNodes((prev) => {
				...
				if (!node && prev.includes(node as unknown as HTMLButtonElement)) {
...
function StepperSeparator({ className }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn(
				"m-0.5 self-start rounded-full bg-muted",
				"group-data-[orientation=horizontal]/stepper-nav:mt-4 group-data-[orientation=horizontal]/stepper-nav:h-0.5 group-data-[orientation=horizontal]/stepper-nav:flex-1",
